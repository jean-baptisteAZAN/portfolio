<script>
	...
	let testimonials = $state([
		...
		{
			name: "Mr MEUNIER",
			username: "Secretaire général - Association DEFENSE ET SAUVEGARDE DU MARCHE AUX FLEURS REINE ELIZABETH II",
...
<div class="relative py-20 bg-gradient-to-br ">
	<div class="w-full">
		...
		<div class="relative flex flex-col  overflow-hidden">
			...
			<div class="pointer-events-none absolute inset-y-0 left-0 w-1/4 bg-gradient-to-r from-surface-900"></div>
			<div class="pointer-events-none absolute inset-y-0 right-0 w-1/4 bg-gradient-to-l from-surface-900"></div>
		</div>
	</div>
</div>
