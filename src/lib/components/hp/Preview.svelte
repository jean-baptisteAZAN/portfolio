...
<div class="mb-20 relative rounded-xl">
	<div
		class="aspect-video rounded-xl overflow-hidden p-1 shadow-lg"
		style="background: linear-gradient(135deg, {gradientFrom}, {gradientTo})"
	>
		<div class="w-full h-full bg-surface-900 rounded-lg overflow-hidden relative">
			<!-- Loading State -->
			...
			<div class="absolute top-0 left-0 right-0 h-8 rounded-none bg-surface-800/80 backdrop-blur-sm flex items-center px-4 gap-2">
